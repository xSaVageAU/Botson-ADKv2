...
// stock ADK's REST/A2A surface -- that surface is fronted separately by
// internal/adkgateway under the "adk." subject prefix (see
// cmd/botson-core/cmd_core.go). This package's subjects, all under
