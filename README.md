...
```powershell
./bin/botsonv2-windows-amd64.exe setup uninstall                       # ask per step: PATH, startup, binary, keep config.json?
./bin/botsonv2-windows-amd64.exe setup uninstall --force-full-uninstall # skip every prompt, completely wipe ~/.botsonv2
